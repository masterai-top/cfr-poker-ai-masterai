#ifndef __MATCH_REWARD_CONFIG_DELETE_H__
#define __MATCH_REWARD_CONFIG_DELETE_H__
class MatchRewardConfigDeleteRequest
{
public:
	MatchRewardConfigDeleteRequest(const string& json) {
...
class MatchRewardConfigDeleteResponse
{
public:
	MatchRewardConfigDeleteResponse(const string& json) {
		this->Deserialize(json);
	}
	template <typename Writer>
	void Serialize(Writer& writer) const {
